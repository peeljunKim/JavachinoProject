...
public class UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User>  {
	 ...
	 @Autowired
	public UserService(MemberDAO_jpa memberdao_jpa, K_UsersRepository k_usersRepository, HttpSession httpSession) {
		super();
		this.memberdao_jpa = memberdao_jpa;
		this.k_usersRepository = k_usersRepository;
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        if (registrationId.equals("kakao")) {
            ...
            // Role 정보를 기반으로 SimpleGrantedAuthority 생성
            SimpleGrantedAuthority authority = new SimpleGrantedAuthority(m.getRole());
